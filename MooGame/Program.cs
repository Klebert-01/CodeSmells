...
class MainClass
    {
        ...
        static string makeGoal()    //does a lot of things, extract to smaller methods 
        {
        ...
        StreamReader input = new StreamReader("result.txt"); //make each high-score post an object then serialize to JSON instead
